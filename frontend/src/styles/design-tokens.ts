/**
 * Design Tokens for Gold Shop Management System
 * Professional color palette, typography, and spacing system
 */

export const designTokens = {
  // Gold Shop Color Palette
  colors: {
    // Primary Gold Colors
    primary: {
    ...
    neutral: {
      ...
      700: '#44403c',  // Text dark
      800: '#292524',  // Text darker
      900: '#1c1917',  // Text darkest
      950: '#0c0a09'   // Text black
    },
  ...
  typography: {
    fontFamily: {
      ...
      display: ['Playfair Display', 'Georgia', 'serif'], // For headings and luxury feel
...
export const getBorderRadius = (key: BorderRadius) => designTokens.borderRadius[key];
export const getBoxShadow = (key: BoxShadow) => designTokens.boxShadow[key];