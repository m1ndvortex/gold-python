      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button
            ...
            size="sm"
            className={cn(
              'h-10 w-10 p-0 hover:bg-primary/10 hover:text-primary-600 transition-all duration-200',
        ...
        <SheetContent 
          side="left" 
          className="p-0 w-80 bg-gradient-to-b from-background to-background/95 border-r border-border/50"
        >
          <div className="flex items-center justify-between p-4 border-b border-border/50">
            ...
            <Button
              ...
              className="h-8 w-8 p-0 hover:bg-primary/10 hover:text-primary-600"
